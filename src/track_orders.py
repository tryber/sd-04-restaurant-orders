from src.analyze_log import most_request
from src.analyze_log import count_asked
...
class TrackOrders:
    ...
    def get_most_ordered_dish_per_costumer(self, costumer):
        return most_request(self.orders, costumer)

    def get_order_frequency_per_costumer(self, costumer, order):
        return count_asked(self.orders, costumer, order)

    def get_never_ordered_per_costumer(self, costumer):
        return never_ordered(self.orders, costumer, self.products, "product")
